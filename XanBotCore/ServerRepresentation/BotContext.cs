...
namespace XanBotCore.ServerRepresentation
{
    ...
    public abstract class BotContext : IConsolePrintable, IEmbeddable
    {
        ...
        {
            if (!Virtual)
                BotContextRegistry.UserDefinedContextsInternal.Add(this);
        }
        ...
        public DiscordGuild Server
        {
            get
            {
                if (CachedServer == null)
                    CachedServer = XanBotCoreSystem.Client.GetGuildAsync(ServerId).GetAwaiter().GetResult();
                return CachedServer;
            }
        }
        ...
        public DiscordMember Bot
        {
            ...
            {
                if (CachedBot == null)
                    CachedBot = Server.GetMemberAsync(XanBotCoreSystem.Client.CurrentUser.Id).GetAwaiter().GetResult();
                return CachedBot;
            }
        }
        ...
        public PassiveHandler[] Handlers
        {
            get
            {
                if (HandlerCache == null)
                {
                    ...
                    if (HandlerCache == null)
                        HandlerCache = new PassiveHandler[0];
                }
                return HandlerCache;
            }
        }
